...
('s1111111-1111-1111-1111-111111111103', 'd1111111-1111-1111-1111-111111111111', 'Dawki', 'town', 'Border town famed for crystal-clear Umngot River where boats appear to float in air.', 'Nov - April', 'https://images.unsplash.com/photo-1518684079-3c830dcef090?w=800&q=80'),
...
('s1111111-1111-1111-1111-111111111105', 'd1111111-1111-1111-1111-111111111111', 'Nongriat', 'attraction', 'Home to iconic Double Decker Living Root Bridge tucked deep in tropical rainforest.', 'Oct - May', 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=800&q=80'),
...
('s1000000-0000-0000-0000-000000000101', 'd1000000-0000-0000-0000-000000000001', 'Old Delhi', 'town', 'Historic quarter featuring Chandni Chowk, ancient heritage lanes, and traditional sweet bazaars.', 'Oct - Mar', 'https://images.unsplash.com/photo-1587474260584-136574528ed5?w=800&q=80'),
('s1000000-0000-0000-0000-000000000102', 'd1000000-0000-0000-0000-000000000001', 'Meena Bazaar', 'shopping', 'Historic marketplace famous for Indian traditional wear, handicrafts, and jewelry.', 'Oct - Mar', 'https://images.unsplash.com/photo-1555529733-0e670560f7e1?w=800&q=80'),
('s1000000-0000-0000-0000-000000000103', 'd1000000-0000-0000-0000-000000000001', 'New Delhi', 'town', 'Capital district showcasing India Gate, Rashtrapati Bhavan, and broad green avenues.', 'Oct - Mar', 'https://images.unsplash.com/photo-1585060544812-6b45742d762f?w=800&q=80'),
('s1000000-0000-0000-0000-000000000104', 'd1000000-0000-0000-0000-000000000001', 'South Delhi', 'town', 'Heritage area featuring Qutub Minar, Lotus Temple, and Chattarpur Temple.', 'Oct - Mar', 'https://images.unsplash.com/photo-1627883204936-a36c1eefdb1f?w=800&q=80'),

-- Varanasi Sub-destinations
('s1000000-0000-0000-0000-000000000201', 'd1000000-0000-0000-0000-000000000002', 'Dashashwamedh Ghat', 'attraction', 'Sacred ghat famous for daily evening Ganga Aarti fire ceremony.', 'Oct - Mar', 'https://images.unsplash.com/photo-1561361513-2d000a50f0dc?w=800&q=80'),
('s1000000-0000-0000-0000-000000000202', 'd1000000-0000-0000-0000-000000000002', 'Kashi Vishwanath Corridor', 'temple', 'Golden spire temple complex dedicated to Lord Shiva.', 'Oct - Mar', 'https://images.unsplash.com/photo-1620023605809-54b00511c97a?w=800&q=80'),

-- Ayodhya Sub-destinations
('s1000000-0000-0000-0000-000000000301', 'd1000000-0000-0000-0000-000000000003', 'Ram Janmabhoomi Complex', 'temple', 'Majestic Nagara style Shri Ram Mandir birthplace shrine.', 'Oct - Mar', 'https://images.unsplash.com/photo-1616082490586-2a6231efb704?w=800&q=80'),
('s1000000-0000-0000-0000-000000000302', 'd1000000-0000-0000-0000-000000000003', 'Hanuman Garhi', 'temple', 'Historic fort temple dedicated to Lord Hanuman protecting Ayodhya.', 'Oct - Mar', 'https://images.unsplash.com/photo-1620023605809-54b00511c97a?w=800&q=80'),

-- Bodh Gaya Sub-destinations
('s1000000-0000-0000-0000-000000000501', 'd1000000-0000-0000-0000-000000000005', 'Mahabodhi Complex', 'temple', 'UNESCO heritage temple and holy Bodhi Tree where Lord Buddha attained enlightenment.', 'Oct - Mar', 'https://images.unsplash.com/photo-1573031070216-7d4efb718228?w=800&q=80')
...
('s1111111-1111-1111-1111-111111111103', 'Jaflong Bangladesh Border View & Suspension Bridge', 'Sightseeing', 1.5, 'Sunset', '{10,11,12,1,2,3,4,5}', 'Walk across Dawki suspension bridge and view Bangladesh stone collection banks.', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&q=80'),
('s1111111-1111-1111-1111-111111111104', 'Asia’s Cleanest Village & Skywalk Tour', 'Cultural', 2.0, 'Morning', '{10,11,12,1,2,3,4,5}', 'Stroll flower-lined cobblestone pathways in Mawlynnong and climb bamboo Sky View tower.', 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=800&q=80'),
('s1111111-1111-1111-1111-111111111105', 'Double Decker Living Root Bridge Trek', 'Trekking', 6.0, 'Full Day', '{10,11,12,1,2,3,4,5}', 'Descend 3,000 steps through lush jungle to famous 250-year-old double decker root bridge.', 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=800&q=80'),
('s1111111-1111-1111-1111-111111111105', 'Rainbow Falls Natural Pool Swim', 'Nature', 3.0, 'Afternoon', '{10,11,12,1,2,3,4,5}', 'Trek further past Nongriat to swim in turquoise waters of Rainbow Falls.', 'https://images.unsplash.com/photo-1533105079780-92b9be482077?w=800&q=80'),
('s1111111-1111-1111-1111-111111111107', 'Krang Suri Waterfalls Swimming & Cliff Jump', 'Adventure', 4.0, 'Afternoon', '{10,11,12,1,2,3,4,5}', 'Swim behind curtain of deep blue Krang Suri waterfalls in West Jaintia Hills.', 'https://images.unsplash.com/photo-1548574505-5e239809ee19?w=800&q=80'),

-- Delhi Activities
('s1000000-0000-0000-0000-000000000101', 'Chandni Chowk Heritage & Culture Walk', 'Cultural', 3.0, 'Morning', '{10,11,12,1,2,3}', 'Explore ancient heritage lanes of Chandni Chowk, traditional spice markets, and sweet shops.', 'https://images.unsplash.com/photo-1587474260584-136574528ed5?w=800&q=80'),
('s1000000-0000-0000-0000-000000000101', 'Red Fort Heritage Monument Walk', 'Sightseeing', 2.0, 'Morning', '{10,11,12,1,2,3}', 'Walk through red sandstone fort, viewing Diwan-i-Aam and royal courtyards.', 'https://images.unsplash.com/photo-1588096236940-0259e8fa2981?w=800&q=80'),
('s1000000-0000-0000-0000-000000000102', 'Meena Bazaar Traditional Shopping Tour', 'Shopping', 2.5, 'Afternoon', '{10,11,12,1,2,3}', 'Shop for handcrafted Indian textiles, embroidery, and traditional attire in Meena Bazaar.', 'https://images.unsplash.com/photo-1555529733-0e670560f7e1?w=800&q=80'),
('s1000000-0000-0000-0000-000000000103', 'India Gate & Central Vista Promenade', 'Sightseeing', 2.0, 'Evening', '{10,11,12,1,2,3}', 'Stroll along Rajpath Central Vista lawn viewing illuminated India Gate monument.', 'https://images.unsplash.com/photo-1585060544812-6b45742d762f?w=800&q=80'),
('s1000000-0000-0000-0000-000000000104', 'Qutub Minar Archaeological Park Tour', 'Sightseeing', 3.0, 'Afternoon', '{10,11,12,1,2,3}', 'Explore towering 73m brick minaret and ancient iron pillar dating back 1,600 years.', 'https://images.unsplash.com/photo-1627883204936-a36c1eefdb1f?w=800&q=80'),
('s1000000-0000-0000-0000-000000000104', 'Lotus Temple Spiritual Silence Meditation', 'Spiritual', 1.5, 'Sunset', '{10,11,12,1,2,3}', 'Experience meditative peace inside lotus-shaped white marble Bahai House of Worship.', 'https://images.unsplash.com/photo-1601004104033-653765108620?w=800&q=80'),

-- Varanasi Activities
('s1000000-0000-0000-0000-000000000201', 'Ganges Sunrise Boat Cruise', 'Spiritual', 2.0, 'Morning', '{10,11,12,1,2,3}', 'Serene boat ride on holy Ganges river watching morning sun rays light up ancient ghats.', 'https://images.unsplash.com/photo-1561361513-2d000a50f0dc?w=800&q=80'),
('s1000000-0000-0000-0000-000000000201', 'Evening Ganga Aarti Fire Ceremony', 'Spiritual', 1.5, 'Evening', '{10,11,12,1,2,3}', 'Witness priests perform rhythmic fire worship offering brass lamps to sacred Ganges.', 'https://images.unsplash.com/photo-1579546929518-9e396f3cc809?w=800&q=80'),
('s1000000-0000-0000-0000-000000000202', 'Kashi Vishwanath Jyotirlinga Darshan', 'Spiritual', 2.5, 'Morning', '{10,11,12,1,2,3}', 'Seek sacred blessings at one of 12 primary Jyotirlinga temples in India.', 'https://images.unsplash.com/photo-1620023605809-54b00511c97a?w=800&q=80'),

-- Ayodhya Activities
('s1000000-0000-0000-0000-000000000301', 'Shri Ram Janmabhoomi Mandir Darshan', 'Spiritual', 3.0, 'Morning', '{10,11,12,1,2,3}', 'Pay respects at grand temple marking sacred birthplace of Lord Rama.', 'https://images.unsplash.com/photo-1616082490586-2a6231efb704?w=800&q=80'),
('s1000000-0000-0000-0000-000000000302', 'Hanuman Garhi Temple Visit', 'Spiritual', 1.5, 'Morning', '{10,11,12,1,2,3}', 'Climb 76 steps to ancient hilltop fort temple dedicated to Lord Hanuman.', 'https://images.unsplash.com/photo-1620023605809-54b00511c97a?w=800&q=80'),

-- Bodh Gaya Activities
('s1000000-0000-0000-0000-000000000501', 'Mahabodhi Temple Meditation Session', 'Spiritual', 2.5, 'Morning', '{10,11,12,1,2,3}', 'Quiet meditation under sacred Bodhi Tree where Lord Buddha attained enlightenment.', 'https://images.unsplash.com/photo-1573031070216-7d4efb718228?w=800&q=80');
